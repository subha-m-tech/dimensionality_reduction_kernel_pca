...
def kernelpca_regression(acclin,accsvml,accsvmnl,accdes,accrf,n): 
    """This method returns dataframe with accuracy of different alogorithms"""
    
    dataframe=pd.DataFrame(index=['kernel pca:'+str(n)],columns=['Linear','SVMl','SVMnl','Decision','Random'
                                                                                     ])
