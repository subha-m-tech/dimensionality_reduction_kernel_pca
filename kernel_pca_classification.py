...
def kernel_PCA(X_train,X_test,n):
    """This method helps to do dimensionality reduction based on n value using Kernel PCA"""
...
def kernelpca_classification(acclog,accsvml,accsvmnl,accknn,accnav,accdes,accrf,n): 
    """This method returns dataframe with accuracy of different alogorithms"""
    dataframe=pd.DataFrame(index=['kernel pca:'+str(n)],columns=['Logistic','SVMl','SVMnl','KNN','Navie','Decision','Random'])
